...
export default function DashboardPage() {
  ...
  const columns = useMemo<Column[]>(
    () =>
      monthly.map((r) => {
        ...
        return {
          label: MONTHS_SHORT[mm - 1] ?? r.month,
  ...
  return (
    <div className="space-y-7">
        ...
        <Card className="lg:col-span-3">
          ...
          <div className="p-5">
            {columns.length > 0 ? (
              ...
              <EmptyState
                title="Ще немає продажів цього року"
                description="Дані з’являться після першого проданого букета."
              />
            )}
          </div>
        </Card>
      ...
      <Card>
        <CardHeader
          title="Найприбутковіші квіти"
          right={<span className="text-xs text-ink-faint">за наваром</span>}
        />
        <div className="p-5">
          {top.length > 0 ? (
            <BarList
