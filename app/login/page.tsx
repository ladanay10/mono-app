...
export default function LoginPage() {
  ...
  return (
    <div className="grid min-h-dvh lg:grid-cols-2">
      {/* Brand panel */}
      <div
        className="relative hidden overflow-hidden border-r border-line lg:block"
        style={{
          background: "linear-gradient(160deg, #191c26 0%, #0b0c10 62%)",
        }}
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(900px 500px at 20% 10%, rgba(255,255,255,0.08), transparent 55%), radial-gradient(700px 600px at 90% 90%, rgba(52,211,153,0.16), transparent 55%)",
          }}
        />
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/80">
              Брудний і чистий дохід, навар по кожній квітці, борги й витрати —
              рахуються самі, щойно ви складаєте букет.
            </p>
          ...
          <div className="text-xs text-white/50">
            © {new Date().getFullYear()} MONO · облік доходів
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8 lg:hidden">
            <div className="mb-4 flex items-center gap-2.5">
              <span className="grid h-10 w-10 place-items-center rounded-xl bg-bloom text-canvas shadow-soft">
          ...
          <p className="mt-1.5 text-sm text-ink-soft">
            Увійдіть, щоб продовжити облік доходів.
          </p>
